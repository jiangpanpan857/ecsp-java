...
class ExceptionTranslatorIT {
    ...
    void testConcurrencyFailure() throws Exception {
        mockMvc
            ...
            .andExpect(jsonPath("$.detail").value("Concurrent task execute failed"));
    }
    ...
    void testMethodArgumentNotValid() throws Exception {
        mockMvc
            .perform(
                post("/api/exception-translator-test/method-argument").with(csrf()).content("{}").contentType(MediaType.APPLICATION_JSON)
            )
